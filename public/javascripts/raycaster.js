...
var canvasShift = canvas.getBoundingClientRect();
...
canvas.addEventListener("mousemove", (e) => {
	player.pos.x = (e.clientX - canvasShift.left) / (canvasShift.right - canvasShift.left) * canvas.width;
	player.pos.y = (e.clientY - canvasShift.top) / (canvasShift.bottom - canvasShift.top) * canvas.height;//mouse location
	drawUpdate();
});
